...
export default {
  ...
  /**
   * Pi - Digit extraction references
   */
  micronaut_pi: async () => ({
    success: true,
    notes: [
      'Rabinowitz and Wagon (1995) describe a spigot algorithm for pi (see Borwein and Bailey 2003, pp. 141-142).',
      'Bailey et al. (1997) and Adamchik & Wagon (1997) describe a base-16 digit-extraction formula for pi (or pi^2).',
    ],
    bbp_formula:
